...
<section class="breadcrumb_main_area margin-bottom-80">
    ...
    <div style="width: 100%; background-image: url(images/garda/sfondo_<?= $base ?>.jpg); background-color: #AB2A58"
        ...
        <div class="breadcrumb_main nice_title uk-overlay uk-light uk-position-center">
            <h2 class="titAlto"
                style="line-height: 72px;background-color: rgba(0, 0, 0, 0.0);text-shadow: 0 0 20px #75343E;">
                Mezza Pensione</h2>
        </div>
...
<div class="other_room_area margin-bottom-55">
    <div class="container">
                    ...
                    <div class="section_content margin-top-10">
                        ...
                        <div class="showcase">
                            <div class="section_description">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <?= getSlider('mezzapensione', 'mangiare') ?>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <ul class="tabPers uk-flex-center uktab" style="border:none;padding: 20px">
            ...
            <li><a href="mezzapensione.php"><span
                            style="color: #333; border-bottom: 1px solid #A82B57;cursor: default;">Mezza pensione</span></a>
            </li>
