...
<section class="breadcrumb_main_area margin-bottom-80">
    ...
    <div style="width: 100%; background-image: url(images/garda/sfondo_<?= $base ?>.jpg); background-color: #AB2A58"
        ...
        <div class="breadcrumb_main nice_title uk-overlay uk-light uk-position-center">
            <h2 class="titAlto"
                style="line-height: 72px;background-color: rgba(0, 0, 0, 0.5);text-shadow: 0 0 20px #000;">
                La Terrazza del Panorama</h2>
        </div>
...
<div class="other_room_area margin-bottom-55">
    <div class="container">
                            ...
                            <div class="uk-card uk-card-default uk-grid-collapse uk-margin" uk-grid>
                                ...
                                <div class="uk-width-2-3@s">
                                    <div class="uk-card-body">
                                        <h3 class="uk-card-title titoloBasso3 uk-heading-line">
                                            <span>La Terrazza del Panorama</span>
                                        </h3>
                                        <p class="text-justify">
                                            Il servizio di mezza pensione viene effettuato minimo 3 giorni consecutivi
                                            nella sala ristorante panoramica interna.<br><br>
                                            Sulla terrazza panoramica si può usufruire del servizio di ristorante à La
                                            Carte.<br><br>
                                            I pasti non consumati non saranno rimborsati.<br><br>
                                            Vi verranno serviti dei gustosi menù a scelta di quattro portate, preparati
                                            con prodotti freschi e genuini secondo le tradizionali ricette della
                                            classica cucina italiana.<br><br>
                                            Preghiamo i gentili ospiti con intolleranze/allergie o che seguono
                                            particolari regimi dietetici di comunicarcelo al momento della prenotazione.
        ...
        <ul class="tabPers uk-flex-center uktab" style="border:none;padding: 20px">
            ...
            <li><a href="mezzapensione.php">Mezza pensione</a>
            </li>
            <li><a href="terrazza.php"><span style="color: #333; border-bottom: 1px solid #A82B57;cursor: default;">La Terrazza del Panorama</span></a></li>
