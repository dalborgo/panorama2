            ...
            <div class="col-lg-12 col-md-12">
                <div class="section_title content-left margin-bottom-5"
                    ...
                    <div class="section_title nice_title content-center" style="height: 70%;" uk-scrollspy="cls: uk-animation-slide-left; repeat: false">
                        <h3 class=""><div class="titoloBasso2">Servizi</div><span class="titoloBasso">Relax</span></h3>
                    </div>
...
<div class="other_room_area margin-bottom-55  padding-top-50">
    <div class="container">
        ...
        <hr class="">
        <ul uk-tab class="tabPers uk-flex-center" style="border:none;padding: 10px">
            ...
            <li><a href="lake.php">Bicicletta</a></li>
            <li><a href="solarium.php">Nordic Walking</a></li>
            <li><a href="garden.php">Vaucher Regalo</a></li>
            <li><a href="garden.php">Spettacoli/Escursioni</a></li>
            <li><a href="garden.php">Taxi</a></li>
            <li><a href="garden.php">Pets</a></li>
        </ul>
        <hr class="">
    </div>
</div>
