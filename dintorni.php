...
<section class="breadcrumb_main_area margin-bottom-80">
    ...
    <div style="width: 100%; background-image: url(images/garda/sfondo_<?= $base ?>.jpg); background-color: #AB2A58"
        ...
        <div class="breadcrumb_main nice_title uk-overlay uk-light uk-position-center">
            <h2 class="titAlto" style="line-height: 72px;background-color: rgba(0, 0, 0, 0.2);">Dintorni</h2>
        </div>
        <div class="uk-overlay bordoSfumato uk-light uk-position-top-right">
            <span style="float: right;text-align:right;"><b>“È ben difficile, in geografia come in morale, capire il mondo senza uscire di casa propria.”
<br>(Voltaire)</b></span>
            <!--<br>
                        ...
                        <div role="tabpanel" class="tab-pane active uk-animation-fade" id="colazione">
                            ...
                            <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin"
                                ...
                                <div class="uk-card-media-left uk-cover-container">
                                    <a href="#modal-center2" uk-toggle> <img src="images/servizi/p1.jpg"
                                                                             alt="colazione">
                                    </a>
                                </div>
                                ...
                                <div>
                                    <div class="uk-card-body">
                                        ...
                                        <p class="text-justify">
                                            La posizione dell’Hotel Panorama Ristorante permette di effettuare magnifiche passeggiate nel verde.<br>
                                            ...
                                            Il Lago di Garda serba dei piccoli stupendi borghi tutti con le loro particolarità e tradizioni.<br>
                                            Simpatico è lo shopping nei negozi e ai mercati settimanali o di artigianato serali.<br>
                                            Nelle immediate vicinanze, oltre a un piacevole bagno nelle dolci acque del lago e una rilassante pausa al sole in una delle tante meravigliose spiagge, si possono eseguire gite sul Monte Baldo con la nuova funivia panoramica e seggiovia o sul Lago di Garda con il comodo servizio di navigazione.<br>
                                            Inoltre vi è la possibilità di praticare numerosi sport: tennis, golf, equitazione, trekking, nordic walking, mountain bike, vela, windsurf, kitesurf e calcio oppure visitare i famosi parchi divertimento di Gardaland, Caneva, Parco termale del Garda, Parco Sigurtà, ecc…<br>
                                            Sono vicine città storiche d’interesse artistico come Verona, Mantova, Venezia e Milano.<br>
