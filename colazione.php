...
<section class="breadcrumb_main_area margin-bottom-80">
    ...
    <div style="width: 100%; background-image: url(images/garda/sfondo_<?= $base ?>.jpg); background-color: #AB2A58"
        ...
        <div class="breadcrumb_main nice_title uk-overlay uk-light uk-position-center">
            <h2 class="titAlto"
                style="line-height: 72px;background-color: rgba(0, 0, 0, 0.0);text-shadow: 0 0 20px #fff;">
                Colazione</h2>
        </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="section_title content-left margin-bottom-5"
                    ...
                    <div class="section_title nice_title content-center" style="height: 70%;"
                        ...
                        <h3 class="">
                            <div class="titoloBasso2">Mangiare</div>
                            <span class="titoloBasso">Love of food</span></h3>
                    </div>
                        ...
                        <div role="tabpanel" class="tab-pane active uk-animation-fade" id="colazione">
                            ...
                            <div class="uk-card uk-card-default uk-grid-collapse uk-margin" uk-grid>
                                <div class="uk-card-media-left uk-cover-container uk-width-1-3@s" align="center">
                                    <img src="images/garda/spalla_<?= $base ?>.jpg" alt="mangiare">
                                </div>
                                <!--<div id="modal-center2" uk-modal="center: true" >
                                    <div class="uk-modal-dialog">
                                        <button class="uk-modal-close-outside" type="button" uk-close></button>
                                        <img src="images/garda/spalla_<? /*= $base */ ?>.jpg" alt="">
                                    </div>
                                </div>-->
                                <div class="uk-width-2-3@s">
                                    <div class="uk-card-body">
                                        <h3 class="uk-card-title titoloBasso3 uk-heading-line"><span>Colazione</span>
                                        </h3>
                                        <p class="text-justify">
                                            Per iniziare nel migliore dei modi la giornata cosa c’è di meglio che
                                            svegliarsi in un’oasi di pace e gustarsi un’ottima colazione con una vista
                                            da sogno sul lago di Garda?<br><br>
                                            Vi aspetta un ricco buffet con prelibatezze dolci e salate: pane e torte
                                            fatti in casa, gustose brioches, marmellate, macedonie di frutta fresca,
                                            yoghurt, muesli, salumi e formaggi, verdure. e poi caffè, cappuccini,
                                            cioccolata, acqua, succhi di frutta e molto altro ancora.<br><br>
                                            Inoltre troverete l’angolo del the e una postazione dove il nostro chef
                                            propone uova e crepe fatte al momento.<br><br>
                                            Per gli ospiti vegetariani e vegani centrifugati di frutta e verdura fresca,
                                            brioches vegane e prodotti BIO.<br><br>
                                            Un’attenzione particolare anche per chi ha intolleranze con una scelta di
