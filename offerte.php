...
<section class="breadcrumb_main_area margin-bottom-80">
    ...
    <div style="width: 100%; background-image: url(images/garda/sfondo_<?= $base ?>.jpg); background-color: #AB2A58" class="uk-background-cover uk-height-large uk-background-primary uk-inline">
        <div class="breadcrumb_main nice_title uk-overlay uk-light uk-position-center">
            <h2 class="titAlto" style="line-height: 72px;background-color: rgba(0, 0, 0, 0.2);text-shadow: 0 0 20px #FBE748;">Offerte</h2>
        </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="section_title content-left margin-bottom-5"
                    ...
                    <div class="section_title nice_title content-center" style="height: 70%;" uk-scrollspy="cls: uk-animation-slide-left; repeat: false">
                        <h3 class=""><span><span class="titoloBasso">Occasioni</span></span></h3>
                    </div>
                    ...
                    <div class="container">
                        <div class="section_title">
                            <ul class="nav nav-tabs margin-bottom-60 uk-flex-center " role="tablist" uk-tab>
                                <li role="presentation" class="active"><a href="#colazione" aria-controls="deluxe_room" role="tab" data-toggle="tab" aria-expanded="true" >Pasqua al lago</a></li>
                                <li role="presentation"><a href="#mezzapensione" aria-controls="deluxe_room" role="tab" data-toggle="tab">È tempo di relax</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin" uk-grid>
                                ...
                                <div>
                                    <div class="uk-card-body">
                                        <h3 class="uk-card-title uk-heading-line titoloBasso4"><span>Pasqua al lago</span></h3>
                                        <p class="text-justify">
                                            a partire da <b>€ 496,00</b><br><br>
                                            dal <b>13.04.2017</b> al <b>21.04.2017</b><br><br>
                                            Per soggiorni di <b>minimo 4 notti</b>
                                        <ul class="uk-list uk-list-bullet">
                                            <li>4 trattamento di camera e colazione al buffet</li>
                                            <li>1 cena con menù degustazione Pasquale (bevande escluse)</li>
                                            <li>1 ingresso Castello Scaligero di Torri del Benaco</li>
                                        </ul>
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane uk-animation-fade" id="mezzapensione">
                            ...
                            <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin" uk-grid>
                                ...
                                <div>
                                    <div class="uk-card-body">
                                        <h3 class="uk-card-title uk-heading-line titoloBasso4"><span>È &nbsp;tempo di relax</span></h3>
                                        <p class="text-justify">
                                            a partire da <b>€ 528,00</b><br><br>
                                            dal <b>18.04.2017</b> al <b>28.04.2017</b><br><br>
                                            dal <b>04.10.2017 </b> al <b>10.10.2017</b><br><br>
                                            Per soggiorni di <b>minimo 6 notti</b> pagate 5 notti e <span style="text-decoration: underline"><b>la sesta ve la regaliamo noi!</b></span>
                                        </p>
                                    </div>
                                </div>
