...
<head>
    ...
    <title>Servizi | Hotel Panorama Ristorante</title>
...
<section class="breadcrumb_main_area margin-bottom-80">
    ...
    <div style="width: 100%; background-image: url(images/garda/sfondo_<?= $base ?>.jpg); background-color: #AB2A58" class="uk-background-cover uk-height-large uk-background-primary uk-inline">
        <div class="breadcrumb_main nice_title uk-overlay uk-light uk-position-center">
            <h2 class="titAlto" style="line-height: 72px;background-color: rgba(0, 0, 0, 0.0);text-shadow: 0 0 20px #000">Animali Domestici</h2>
        </div>
...
<div class="other_room_area margin-bottom-55  padding-top-50">
    <div class="container">
                               ...
                               <!-- <div id="modal-center2" uk-modal="center: true" >
                                ...
                                <div class="uk-width-2-3@s">
                                    <div class="uk-card-body">
                                        <h3 class="uk-card-title titoloBasso3 uk-heading-line"><span>Animali Domestici</span></h3>
                                        <p class="text-justify">
                                            Per chi ha bisogno di un trasferimento da/per aeroporto o stazione ferroviaria, per chi vuole andare all’opera in Arena o per chi più semplicemente desidera passare una serata in libertà senza la preoccupazione di dover guidare, l’Hotel Panorama Ristorante può riservarVi un comodo taxi tranfer.<br><br>
                                            Per informazioni, costi e prenotazioni contattateci sezione “richiesta informazioni”, per e-mail o direttamente alla reception.

                                            Per chi desidera portare in vacanza il  proprio amico a quattro zampe, l’hotel Panorama Ristorante è felice di accoglierlo.<br><br>
                                            Per i Vostri animali sono dedicate le stanze di tipologia VILLAGE oppure LAKE.<br><br>
                                            Il supplemento per ogni animale è di Euro 10,00 al giorno (cibo escluso).<br><br>
                                            Queste sono le nostre piccole regole per garantire il massimo comfort anche a tutti gli altri
                                            ospiti:<ul>
                                            <li>Gli animali non devono essere lasciati incustoditi sia in stanza che nelle aree comuni.</li>
                                            <li>È gentilmente richiesto l’utilizzo del guinzaglio negli spazi comuni.</li>
                                            <li>I pets sono ammessi in sala ristorante e Terrazza e in tutte le zone comuni previo avviso al personale.</li>
                                            <li>I pets non sono ammessi in piscina.</li>
                                            <li>Qualora si verificassero dei danneggiamenti saranno addebitati.</li>
                                            </ul>
        ...
        <ul class="tabPers uk-flex-center uktab" style="border:none;padding: 10px">
            ...
            <li><a href="pets.php"><span style="color: #333; border-bottom: 1px solid #A82B57;cursor: default;">Pets</a></li>
        </ul>
